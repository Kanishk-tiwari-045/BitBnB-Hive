export const features = [
  {
    ...
    caption: "Empower Your Online Presence with BitBnB",
    title: "Truly Decentralized",
    text: "Enjoy seamless, censorship-resistant hosting where your content stays online, owned and managed by you, not a central authority.",
    button: {
  ...
  },
  {
    ...
    caption: "Empower Your Content",
    title: "Flexible Hosting",
    text: "Host websites, images, documents, and much more in a decentralized ecosystem that adapts to your needs.",
    button: {
...
export const faq = [
  {
    id: "0",
    question: "How does BitBnB use IPFS Pinata for hosting?",
    answer:
      "BitBnB utilizes IPFS Pinata to securely store and manage your content in a decentralized manner. This ensures your files remain accessible and tamper-proof.",
  },
  {
    id: "1",
    question: "What type of content can I host on BitBnB?",
    answer:
      "You can host a variety of content, including websites, images, documents, and other digital files within our decentralized ecosystem.",
  },
  {
    id: "2",
    question: "How do I access my hosted content?",
    answer:
      "Once your content is deployed, you will receive a unique link that you can use to access and share your files easily.",
  },
  {
    id: "3",
    question: "What factors determine my hosting fees?",
    answer:
      "Our pricing model is based on the size of your hosted content and its scalability needs. You only pay for what you use, ensuring cost-effectiveness.",
  },
  {
    id: "4",
    question: "Can I scale my hosting plan as my needs grow?",
    answer:
      "Yes! You can easily upgrade or scale your hosting plan at any time to accommodate your growing storage and bandwidth requirements.",
  },
  {
    id: "5",
    question: "What happens if I exceed my storage limits?",
    answer:
      "If you exceed your storage limits, you will be notified, and you can choose to upgrade your plan or manage your content to free up space.",
  },
  {
    id: "6",
    question: "Is my content secure on BitBnB?",
    answer:
      "Absolutely! With IPFS Pinata, your content is encrypted and distributed across multiple nodes, providing robust security against data loss and censorship.",
  },
  {
    id: "7",
    question: "How can I track my usage and billing?",
    answer:
      "You can monitor your storage usage and billing information through your BitBnB dashboard, where you'll find detailed insights about your account.",
  },
  {
    id: "8",
    question: "Do you offer customer support?",
    answer:
      "Yes! Our support team is available to assist you with any inquiries or issues you may encounter while using BitBnB.",
  },
  {
    id: "9",
    question: "Can I integrate BitBnB with other platforms?",
    answer:
      "Yes! BitBnB is designed to be interoperable with various decentralized applications, allowing you to extend its functionality with ease.",
  },
];
